...
{
    [TestClass]
    public class TestCompanyGetJoinRequests
    {
        ...
        [TestMethod]
        public void TestGetJoinRequestsIncorrectFormat()
        {
        ...
        [TestMethod]
        public void TestGetJoinRequestsUnknownUser()
        {
        ...
        [TestMethod]
        public void TestGetJoinRequestsUnauthorizedUser()
        {
        ...
        [TestMethod]
        public void TestGetJoinRequestsInvalidLoginToken()
        {
            StringConstructor.SetMapping("UserId", 1);
            string testString = StringConstructor.ToString();
            StringContent content = new StringContent(testString);
        ...
        [TestMethod]
        public void TestGetJoinRequestsInvalidAuthToken()
        {
        ...
        [TestMethod]
        public void TestGetJoinRequestsValidRequest()
        {
            string testString = StringConstructor.ToString();
            StringContent content = new StringContent(testString);
            var response = Client.SendAsync(new HttpRequestMessage() { Content = content, RequestUri = new System.Uri(Uri), Method = HttpMethod.Get }).Result;
