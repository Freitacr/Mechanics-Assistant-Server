...
namespace MechanicsAssistantServerTests.TestNet.TestApi.TestRepairJob {
    ...
    [TestClass]
    public class TestDownvoteAuxillaryRequirement {
        ...
        [TestMethod]
        public void TestValidDownvoteAuxillaryRequirement() {
        ...
        [TestMethod]
        public void TestNotFoundOnNonExistentAuxillaryRequirement() {
            throw new NotImplementedException();
        }
