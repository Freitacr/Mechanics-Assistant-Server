...
{
    [TestClass]
    public class TestAcceptOpenJoinRequest
    {

        private static CompanyRequestsApi TestApi;
        ...
        public static void InitializeClass(TestContext context)
        {
            ...
            TestApi = new CompanyRequestsApi(10000);
        }
        ...
        [TestMethod]
        public void TestNotFoundOnNonExistentJoinRequest()
        {
            throw new NotImplementedException();
        }
