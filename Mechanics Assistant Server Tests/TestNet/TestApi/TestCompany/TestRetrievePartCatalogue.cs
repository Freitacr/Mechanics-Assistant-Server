...
namespace MechanicsAssistantServerTests.TestNet.TestApi.TestCompany {
    ...
    [TestClass]
    public class TestRetrievePartCatalogue
    {
        ...
        [TestMethod]
        public void TestBadRequestOnInvalidStartRange(){
            throw new NotImplementedException();
        }

        [TestMethod]
        public void TestBadRequestOnInvalidEndingRange() {
            throw new NotImplementedException();
        }

        [TestMethod]
        public void TestBadRequestOnEndingBeforeStart() {
            throw new NotImplementedException();
        }
