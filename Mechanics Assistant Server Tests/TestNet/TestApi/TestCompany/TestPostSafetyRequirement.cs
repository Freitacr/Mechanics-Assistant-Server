...
{
    [TestClass]
    public class TestPostSafetyRequirement
    {

        private static CompanySafetyRequestApi TestApi;
        ...
        public static void InitializeClass(TestContext context)
        {
            ...
            TestApi = new CompanySafetyRequestApi(10000);
        }
        ...
        [TestMethod]
        public void TestBadRequestOnEmptySafetyRequirements()
        {
            throw new NotImplementedException();
        }

        [TestMethod]
        public void TestNotFoundOnNonExistentCompany()
        {
            throw new NotImplementedException();
        }

        [TestMethod]
        public void TestNotFoundOnNonExistentRepairJobEntry()
        {
            throw new NotImplementedException();
        }
