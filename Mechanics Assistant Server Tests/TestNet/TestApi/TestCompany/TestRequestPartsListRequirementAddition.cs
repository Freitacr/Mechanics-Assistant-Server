...
{
    [TestClass]
    public class TestRequestPartsListRequirementAddition
    {

        private static CompanyPartslistsRequestsApi TestApi;
        ...
        public static void InitializeClass(TestContext context)
        {
            ...
            TestApi = new CompanyPartslistsRequestsApi(10000);
        }
        ...
        [TestMethod]
        public void TestBadRequestOnEmptyRequiredPartsList()
        {
            throw new NotImplementedException();
        }
