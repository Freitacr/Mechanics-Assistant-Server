...
{
    [TestClass]
    public class TestAcceptOpenSafetyAdditionRequest
    {
        ...
        [TestMethod]
        public void TestBadRequestOnInvalidRequestId()
        {
            throw new NotImplementedException();
        }
        ...
        [TestMethod]
        public void TestNotFoundOnNonExistentRequest()
        {
            throw new NotImplementedException();
        }
        ...
        [TestMethod]
        public void TestUnauthorizedOnNonSafetyUser()
        {
            throw new NotImplementedException();
        }
    }
