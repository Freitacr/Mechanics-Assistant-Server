...
{
    [TestClass]
    public class TestCompanyDenySafetyAdditionRequest
    {
        ...
        [TestMethod]
        public void TestDenySafetyRequestIncorrectFormat()
        {
        ...
        [TestMethod]
        public void TestDenySafetyRequestUnknownUser()
        {
        ...
        [TestMethod]
        public void TestDenySafetyRequestUnauthorizedUser()
        {
        ...
        [TestMethod]
        public void TestDenySafetyRequestInvalidLoginToken()
        {
            StringConstructor.SetMapping("UserId", 1);
            string testString = StringConstructor.ToString();
            StringContent content = new StringContent(testString);
        ...
        [TestMethod]
        public void TestDenySafetyRequestInvalidAuthToken()
        {
        ...
        [TestMethod]
        public void TestDenySafetyRequestValidRequest()
        {
            string testString = StringConstructor.ToString();
            StringContent content = new StringContent(testString);
            var response = Client.SendAsync(new HttpRequestMessage(HttpMethod.Delete, Uri) { Content = content }).Result;
            ...
            RequirementsEntry requirements = serializer.ReadObject(streamIn) as RequirementsEntry;
            Assert.AreNotEqual(null, requirements);
            Assert.IsFalse(requirements.Safety.Contains("Wear a Hard Hat"));
        }
