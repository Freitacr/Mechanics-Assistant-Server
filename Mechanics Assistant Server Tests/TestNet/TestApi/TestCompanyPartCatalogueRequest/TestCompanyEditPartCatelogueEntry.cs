...
{
    [TestClass]
    public class TestCompanyEditPartCatelogueEntry
    {
        ...
        public void FillStringConstructor()
        {
            ...
            StringConstructor.SetMapping("FieldName", "Year");
            StringConstructor.SetMapping("FieldValue", 1984);
        }
        ...
        [TestMethod]
        public void TestEditPartCatelogueIncorrectFormat()
        {
        ...
        [TestMethod]
        public void TestEditPartCatelogueUnknownUser()
        {
        ...
        [TestMethod]
        public void TestEditPartCatelogueUnauthorizedUser()
        {
        ...
        [TestMethod]
        public void TestEditPartCatelogueInvalidLoginToken()
        {
            StringConstructor.SetMapping("UserId", 1);
            string testString = StringConstructor.ToString();
            StringContent content = new StringContent(testString);
        ...
        [TestMethod]
        public void TestEditPartCatelogueInvalidAuthToken()
        {
        ...
        [TestMethod]
        public void TestEditPartCatelogueValidRequest()
        {
            string testString = StringConstructor.ToString();
            StringContent content = new StringContent(testString);
            var response = Client.PatchAsync(Uri, content).Result;
