...
{
    [TestClass]
    public class TestCompanyForumDeleteRequest
    {
        ...
        public void FillStringConstructor()
        {
            ...
            StringConstructor.SetMapping("ForumPostId", 1);
        ...
        [TestMethod]
        public void TestForumDeleteRequestIncorrectFormat()
        {
        ...
        [TestMethod]
        public void TestForumDeleteRequestUnknownUser()
        {
        ...
        [TestMethod]
        public void TestForumDeleteRequestInvalidLoginToken()
        {
        ...
        [TestMethod]
        public void TestForumDeleteRequestInvalidAuthToken()
        {
        ...
        [TestMethod]
        public void TestForumDeleteRequestUnauthorizedUser()
        {
            StringConstructor.SetMapping("UserId", 2);
        ...
        [TestMethod]
        public void TestForumDeleteRequestValidRequest()
        {
            string testString = StringConstructor.ToString();
            StringContent content = new StringContent(testString);
            var response = Client.SendAsync(new HttpRequestMessage(HttpMethod.Delete, Uri) { Content = content }).Result;
            ...
            Assert.AreEqual(0, forumPosts.Count);
        }
    }
}
