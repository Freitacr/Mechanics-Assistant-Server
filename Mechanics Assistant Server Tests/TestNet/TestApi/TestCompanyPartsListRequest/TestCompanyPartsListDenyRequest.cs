...
{
    [TestClass]
    public class TestCompanyPartsListDenyRequest
    {
        ...
        [TestMethod]
        public void TestDenyPartsListRequestIncorrectFormat()
        {
        ...
        [TestMethod]
        public void TestDenyPartsListRequestUnknownUser()
        {
        ...
        [TestMethod]
        public void TestDenyPartsListRequestUnauthorizedUser()
        {
        ...
        [TestMethod]
        public void TestDenyPartsListRequestInvalidLoginToken()
        {
            StringConstructor.SetMapping("UserId", 1);
            string testString = StringConstructor.ToString();
            StringContent content = new StringContent(testString);
        ...
        [TestMethod]
        public void TestDenyPartsListRequestInvalidAuthToken()
        {
        ...
        [TestMethod]
        public void TestDenyPartsListRequestValidRequest()
        {
            string testString = StringConstructor.ToString();
            StringContent content = new StringContent(testString);
            var response = Client.SendAsync(new HttpRequestMessage(HttpMethod.Delete, Uri) { Content = content }).Result;
            ...
            Assert.IsFalse(requirements.Parts.Contains(1));
        }
    }
}
