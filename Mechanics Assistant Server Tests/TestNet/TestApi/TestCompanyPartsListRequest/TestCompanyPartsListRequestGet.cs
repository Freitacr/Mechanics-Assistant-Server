...
{
    [TestClass]
    public class TestCompanyPartsListRequestGet
    {
        ...
        public static void SetupTestSuite(TestContext ctx)
        {
            ...
            Manipulator.AddPartsListAdditionRequest(1, new RequirementAdditionRequest(1, 1, "10mmm Wrench"));
        }
        ...
        [TestMethod]
        public void TestGetPartsListRequestsIncorrectFormat()
        {
        ...
        [TestMethod]
        public void TestGetPartsListRequestsUnknownUser()
        {
        ...
        [TestMethod]
        public void TestGetPartsListRequestsUnauthorizedUser()
        {
        ...
        [TestMethod]
        public void TestGetPartsListRequestsInvalidLoginToken()
        {
            StringConstructor.SetMapping("UserId", 1);
            string testString = StringConstructor.ToString();
            StringContent content = new StringContent(testString);
        ...
        [TestMethod]
        public void TestGetPartsListRequestsInvalidAuthToken()
        {
        ...
        [TestMethod]
        public void TestGetPartsListRequestsValidRequest()
        {
            string testString = StringConstructor.ToString();
            StringContent content = new StringContent(testString);
            var response = Client.SendAsync(new HttpRequestMessage() { Content = content, RequestUri = new System.Uri(Uri), Method = HttpMethod.Get }).Result;
