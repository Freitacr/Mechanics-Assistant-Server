...
{
    [TestClass]
    public class TestCompanyPartsListEditRequest
    {
        ...
        [TestMethod]
        public void TestEditPartsListRequestIncorrectFormat()
        {
            ...
            var response = Client.SendAsync(new HttpRequestMessage(HttpMethod.Patch, Uri) { Content = content }).Result;
            Assert.AreEqual(System.Net.HttpStatusCode.BadRequest, response.StatusCode);
        }

        [TestMethod]
        public void TestEditPartsListRequestUnknownUser()
        {
        ...
        [TestMethod]
        public void TestEditPartsListRequestUnauthorizedUser()
        {
        ...
        [TestMethod]
        public void TestEditPartsListRequestInvalidLoginToken()
        {
            StringConstructor.SetMapping("UserId", 1);
            string testString = StringConstructor.ToString();
            StringContent content = new StringContent(testString);
        ...
        [TestMethod]
        public void TestEditPartsListRequestInvalidAuthToken()
        {
        ...
        [TestMethod]
        public void TestEditPartsListRequestValidRequest()
        {
            string testString = StringConstructor.ToString();
            StringContent content = new StringContent(testString);
            var response = Client.SendAsync(new HttpRequestMessage(HttpMethod.Patch, Uri) { Content = content }).Result;
            ...
            Assert.AreEqual("[1]", request.RequestedAdditions);
        }
