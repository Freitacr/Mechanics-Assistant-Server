...
namespace MechanicsAssistantServerTests.TestNet.TestApi.TestCompanyPartsRequest
{
    public class TestCompanyPartsRequestGet
    {
        ...
        public static void SetupTestSuite(TestContext ctx)
        {
            ...
            Manipulator.AddPartEntry(1, new PartCatalogueEntry("all", "all", -1, "bcd", "10mm Wrench"));
        }
        ...
        [TestMethod]
        public void TestGetPartsRequestsIncorrectFormat()
        {
        ...
        [TestMethod]
        public void TestGetPartsRequestsUnknownUser()
        {
        ...
        [TestMethod]
        public void TestGetPartsRequestsUnauthorizedUser()
        {
        ...
        [TestMethod]
        public void TestGetPartsRequestsInvalidLoginToken()
        {
            StringConstructor.SetMapping("UserId", 1);
            string testString = StringConstructor.ToString();
            StringContent content = new StringContent(testString);
        ...
        [TestMethod]
        public void TestGetPartsRequestsInvalidAuthToken()
        {
        ...
        [TestMethod]
        public void TestGetPartsRequestsValidRequest()
        {
            string testString = StringConstructor.ToString();
            StringContent content = new StringContent(testString);
            var response = Client.SendAsync(new HttpRequestMessage() { Content = content, RequestUri = new System.Uri(Uri), Method = HttpMethod.Get }).Result;
            ...
            PartsRequest req = requests[0];
            Assert.AreEqual(1, req.UserId);
            Assert.AreEqual("[1]", req.ReferencedParts);
            Assert.AreEqual("abc", req.JobId);
        }
    }
}
