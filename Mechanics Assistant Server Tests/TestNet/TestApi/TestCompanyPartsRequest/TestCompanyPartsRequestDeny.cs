...
{
    [TestClass]
    public class TestCompanyPartsRequestDeny
    {
        ...
        [TestMethod]
        public void TestDenyPartsRequestIncorrectFormat()
        {
        ...
        [TestMethod]
        public void TestDenyPartsRequestUnknownUser()
        {
        ...
        [TestMethod]
        public void TestDenyPartsRequestUnauthorizedUser()
        {
        ...
        [TestMethod]
        public void TestDenyPartsRequestInvalidLoginToken()
        {
            StringConstructor.SetMapping("UserId", 1);
            string testString = StringConstructor.ToString();
            StringContent content = new StringContent(testString);
        ...
        [TestMethod]
        public void TestDenyPartsRequestInvalidAuthToken()
        {
        ...
        [TestMethod]
        public void TestDenyPartsRequestValidRequest()
        {
            string testString = StringConstructor.ToString();
            StringContent content = new StringContent(testString);
            var response = Client.SendAsync(new HttpRequestMessage(HttpMethod.Delete, Uri) { Content = content }).Result;
